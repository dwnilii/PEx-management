...
const navItems = [
  ...
  { href: '/dashboard/ou', icon: Building2, label: 'OU' },
  { href: '/dashboard/users', icon: Users, label: 'Users' },
  { href: '/dashboard/proxy', icon: Network, label: 'Proxy' },
  { href: '/dashboard/routing-rule', icon: GitBranch, label: 'Routing Rule' },
  { href: '/dashboard/extension', icon: Puzzle, label: 'Extension' },
    ...
    <>
      <SidebarHeader>
        <div className="flex items-center gap-2 h-16 w-full px-4">
            ...
            <span className="whitespace-nowrap text-lg font-semibold">PEx-Management</span>
        </div>
      </SidebarHeader>
