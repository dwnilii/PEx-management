...
// POST to create or update the extension settings
export async function POST(request: NextRequest) {
  try {
    ...
    // We store the entire settings object as a single JSON string in the database.
    // The "UPSERT" logic (INSERT OR REPLACE) ensures that if the key exists, it's updated,
    // and if it doesn't, it's created.
